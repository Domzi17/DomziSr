...
\section*{\textbf{\LARGE{Magični kvadrati}}}
...
\begin{itemize}
   ...
   \item \url{http://en.wikipedia.org/wiki/Magic_squaren}
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
...
\section{Uvod}
   ...
   Magični kvadrat reda ?? je nabor ?? različnih števil,
